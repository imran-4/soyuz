...
import org.apache.flink.table.plan.nodes.datastream.DataStreamRepeatUnion
import org.apache.flink.table.plan.nodes.logical.FlinkLogicalRepeatUnion

class DataStreamRepeatUnionRule
...
object DataStreamRepeatUnionRule {
  val INSTANCE: RelOptRule = new DataStreamRepeatUnionRule
}
