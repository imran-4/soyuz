...
import org.apache.flink.table.plan.rules.dataSet.DataSetTableSpoolRule

class DataStreamTableSpoolRule
...
object DataStreamTableSpoolRule {
  val INSTANCE: RelOptRule = new DataStreamTableSpoolRule
}
